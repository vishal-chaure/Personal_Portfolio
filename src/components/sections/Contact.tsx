...
export const Contact: React.FC = () => {
  ...
  return (
    ...
    >
      <div ref={ref} className="max-w-3xl lg:max-w-4xl mx-auto w-full">
        <motion.div
        ...
        >
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 lg:p-10">
            <motion.p
              ...
              className="text-base sm:text-lg lg:text-xl text-white/80 leading-relaxed mb-6 sm:mb-8 max-w-2xl mx-auto"
            >
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-5 justify-center items-center mb-6 sm:mb-8"
            >
              <motion.a
                href="mailto:palchaure@gmail.com"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 sm:gap-3 px-5 sm:px-6 lg:px-7 py-2.5 sm:py-3 rounded-lg bg-white text-black font-medium text-sm sm:text-base hover:bg-white/90 transition-colors w-full sm:w-auto justify-center"
              >
                <Mail size={18} />
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 sm:gap-3 px-5 sm:px-6 lg:px-7 py-2.5 sm:py-3 rounded-lg border border-white/20 hover:bg-white/10 transition-colors text-sm sm:text-base w-full sm:w-auto justify-center"
              >
                <Download size={18} />
            ...
            >
              <p className="text-white/60 text-xs sm:text-sm mb-3 sm:mb-4">Connect with me on social media</p>

      ...
      <div ref={ref} className="section-container">
        ...
        <div className="relative">
          ...
          {educationData.map((item, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute top-0 left-[-8px] md:left-auto md:right-[-8px] w-4 h-4 rounded-full bg-white z-10"></div>

              <div className="glass-morphism p-6 rounded-2xl md:rounded-2xl hover:bg-white/10 transition-all duration-300">
                <h3 className="text-xl font-semibold mb-2 text-gradient">
                  {item.institution}
                </h3>
                <p className="text-white mb-2">{item.degree}</p>
                <div className="flex flex-col md:flex-row md:justify-between md:items-center text-white/60 text-sm">

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {projectsData.map((project, index) => (
            ...
            >
              ...
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl hover:shadow-purple-500/10 transition-all duration-500 hover:border-white/20 h-full">
                <div className="overflow-hidden rounded-xl mb-6 bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                  ...
                  >
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-center px-4 relative z-10">
                      {project.title}
                    </h3>
                  </motion.div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1.5 text-xs sm:text-sm rounded-full bg-white/10 text-white/70 border border-white/5"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex justify-center">
                  <span className="text-white/60 hover:text-white transition-colors text-sm font-medium">
